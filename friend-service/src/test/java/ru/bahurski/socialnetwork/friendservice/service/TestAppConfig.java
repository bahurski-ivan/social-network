...
@EnableJpaRepositories(basePackageClasses = ru.bahurski.socialnetwork.friendservice.repository.Marker.class)
public class TestAppConfig {
    @Bean
    FriendService dialogService(FriendRelationRepo friendRelationRepo, FriendRequestRepo friendRequestRepo,
    ...
    public EntityManagerFactory entityManagerFactory(DataSource dataSource,
        ...
        factory.setPackagesToScan(FriendRelation.class.getPackage().getName());
